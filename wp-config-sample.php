...
// On surcharge la valeur Adresse web du site présente dans le backoffice
define( 'WP_HOME', 'put your home url here' );
// On surcharge la valeur Adresse web de WordPress présente dans le backoffice
define( 'WP_SITEURL', rtrim( WP_HOME, '/' ) . '/wp' );

// Constantes magiques : https://www.php.net/manual/fr/language.constants.predefined.php
