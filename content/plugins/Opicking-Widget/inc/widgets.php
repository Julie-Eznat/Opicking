    ...
    public function widget($args, $instance)
    {
        ...
        echo $before_widget;
            if (! empty($title))
                ...
                // ideal serait de modifier la requete et de retirer le titre ** Julie E
            ?>
          
         
                <?php foreach ($terms as $term):; 
 // je modifie le FOREACH INITIAL pour afficher une différence entre les catégories et sous catégories. 
                  if($term->parent == 0) :    //CARTEGORIE PARENT  ?>
                    <a class="dropdown-item" tabindex="-1" href="<?php echo get_term_link($term); ?>"><h5><?php echo $term->name; ?></h5></a>
                <?php endif;
                            if($term->parent != 0) :  // ENFANTS    ?>
                            <a class="dropdown-item" tabindex="-1" href="<?php echo get_term_link($term); ?>"><?php echo $term->name; ?></a>
                            <?php endif;
                endforeach; ?>
